    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TruckTypeID = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    StartOfShipping = table.Column<DateTime>(nullable: false),
                    EndOfShipping = table.Column<DateTime>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cargo_TruckType_TruckTypeID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Transport_TruckType_TruckTypeID",
                        column: x => x.TruckTypeID,
                        principalTable: "TruckType",
                        principalColumn: "TruckTypeID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cargo_TruckTypeID",
                table: "Cargo",
                column: "TruckTypeID");

            migrationBuilder.CreateIndex(
                name: "IX_Transport_CompanyID",
                table: "Transport",
                column: "CompanyID");

            migrationBuilder.CreateIndex(
                name: "IX_Transport_TruckTypeID",
                table: "Transport",
                column: "TruckTypeID");
        }
